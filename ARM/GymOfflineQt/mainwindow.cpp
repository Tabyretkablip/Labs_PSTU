...
{
    resize(1100, 720);
    setWindowTitle("Оффлайн система для фитнес-зала");
    showAuthPage();
}
...
void MainWindow::showAuthPage()
{
    ...
    QLabel *title = makeTitle("Фитнес-зал — оффлайн система");
    ...
    QPushButton *toRegButton = new QPushButton("Нет аккаунта? Зарегистрироваться");
    ...
    QPushButton *toLoginButton = new QPushButton("Уже есть аккаунт? Войти");
